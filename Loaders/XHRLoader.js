 ...
 * @constructor     Creates new XHRLoader object. If manager is undefined the default LoadingManager will be used.
 */
...
XHRLoader.prototype = {
    ...
    /**
     * This should be called when you want to set the request path in advance
